...
FULLBODY_GROUPS = {
    ...
    "GROUP_A": { 
        # 💡 PMP(보정) 뼈대들을 부모 뼈대와 함께 동작하도록 GROUP_A에 모두 추가
        "bones": {
    ...
    "GROUP_F": { 
        "bones": {"R_Hand"}, 
        "basis": (90, 0, 90), 
        # 💡 문서의 180도 회전 지시를 반영하여 offset을 (180, 0, 0)으로 테스트
        "flip": False, 
        "offset": (90, 0, 0), 
        "loc_map": ("x", "y", "z"), 
        "scale_div": 100.0
    ...
    # 💡 [신설] 척추 주변 보조 뼈대 (HARA_ROT1 포함)
    "GROUP_BODY_AUX": { 
        "bones": {"HARA_ROT1", "MUKI", "MUNE_jnt", "KOSI_NULL2", "Neck2", "BASE", "C_Leg"}, 
        "basis": (0, 0, 90), 
        "flip": False, 
        "offset": (0, 0, 0), 
        "loc_map": ("x", "y", "z"), 
    ...
    # 💡 [신설] 무기, 물리엔진, 옷자락 등 소품 뼈대 모음 (offset 0,0,0으로 시작)
    "GROUP_PROPS_PHYSICS": {
        "bones": {
            "ATH_Hip_Body", "ATH_Hip_Root", "ATH_Hip_bottom", "ATH_Hip_box_cover", "ATH_Hip_box_studs", 
            "ATH_Hip_front_grip", "ATH_Hip_grip_base", "ATH_Hip_grip_rot", "ATH_Hip_saya01", "ATH_Hip_saya02", 
            "ATH_Hip_saya03", "ATH_Hip_saya04", "ATH_Hip_scope_base_rot", "ATH_Hip_scope_extend", "ATH_Hip_scope_rot_a", 
            "ATH_Hip_scope_rot_b", "ATH_Hip_scope_rot_c", "ATH_Hip_scope_rot_d", "ATH_Hip_stretch", "ATH_Hip_top", 
            "ATH_Hip_trigger", "ATH_Hip_tsuka", "ATH_L_Arm_separator", "ATH_L_Hand_separator", "ATH_L_LowerArm", 
            ...
            "ATH_L_got_Ring3", "ATH_L_got_Thumb0", "ATH_L_got_Thumb1", "ATH_L_got_Thumb2", "ATH_L_knife", 
            "ATH_L_saya01", "ATH_L_saya02", "ATH_L_saya03", "ATH_L_saya04", "ATH_L_spear", "ATH_L_spear_2nd", 
            "ATH_L_tsuka", "ATH_L_weapon001", "ATH_Neck_separator", "ATH_R_Arm_separator", "ATH_R_Hand_separator", 
            "ATH_R_LowerArm", "ATH_R_Thigh_karambit", "ATH_R_burnier", "ATH_R_burnier_separator", "ATH_R_flashlight", 
            "ATH_R_folding001", "ATH_R_folding002", "ATH_R_folding003", "ATH_R_folding004", "ATH_R_folding005", 
            "ATH_R_folding006", "ATH_R_grenade", "ATH_R_handgun01", "ATH_R_handgun02", "ATH_R_karambit", 
            "ATH_R_katana", "ATH_R_spear", "ATH_R_spear_2nd", "ATH_R_weapon001", "ATH_Spine1_separator", "ATH_cane", 
            "ATH_chest_beam", "ATH_katanaL_1st", "ATH_katanaL_2nd", "ATH_katanaR_1st", "ATH_katanaR_2nd", 
            "ATH_katasaya_1st", "ATH_katasaya_2nd", "ATH_katatuka", "ATH_mnt_C_burnier_back", "ATH_mnt_L_burnier_back", 
            "ATH_mnt_R_burnier_back", "ATH_pikL_1st", "ATH_pyaL_1st", "ATH_pyaL_2nd", "ATH_pyaR_1st", "ATH_pyaR_2nd", 
            "ATH_pyaR_B_1st", "ATH_pyaR_B_2nd", "ATH_saya_1st", "ATH_saya_2nd", "ATH_swordR_1st", "ATH_swordR_2nd", 
            "ATH_sword_back", "ATH_tail_01", "ATH_tail_02", "ATH_tail_03", "ATH_tail_04", "ATH_tail_05", "ATH_tail_06", 
            "ATH_tail_07", "ATH_tail_08", "ATH_tail_09", "ATH_tail_10", "ATH_tail_11", "ATH_tail_12", "ATH_tail_13", 
            "ATH_tail_14", "ATH_tail_15", "ATH_tail_16", "ATH_thirdeye_beam", "ATH_tuka_top", "ATH_visor001", 
            "ATH_visor002", "ATH_visor003", "ATH_visor004", "BUKI_1_jnt", "BUKI_2_jnt", "L_Have", "L_Have2", 
            "R_Have", "R_Have2", "mushi_R_1", "mushi_R_2", "mushi_R_3", "mushi_R_4", "mushi_R_5", "mushi_R_6", 
            "mushi_R_7", "mushi_R_8"
        },
        "basis": (0, 0, 90),
        "flip": False,
...
CATEGORY_MASKS = {
    'FULLBODY': MASK_FULLBODY_EXTRA,
    'EXTRA': MASK_FULLBODY_EXTRA,
    'HAND': MASK_HAND_L.union(MASK_HAND_R), # 기본은 합집합, 로직에서 파일 뜯어보고 좌/우 분리
    'FACIAL': {
